// S_AnimateUVs:
// - Runs the timers keeping track of frames on entities with C_Animates using animation speed
// - Sets UV coords on C_Hasmesh to the correct frame to display
// - Destroys the entity if it is tagged to destroyAfterAnim in C_Animates
